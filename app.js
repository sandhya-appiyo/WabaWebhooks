...
app.get("/webhook", (req, res) => {
 ...
 let config = {};
 config.verifyToken = "WABAONBOARD"
...
app.post("/webhook", (req, res) => {
  ...
  if (body.object === "whatsapp_business_account") {
    ...
    // Catch if the event came from Messenger webhook instead of WABA
    console.warn(
      `Received Messenger "page" object instead of "WABA" message webhook.`
    );
    res.sendStatus(404);
  } else {
